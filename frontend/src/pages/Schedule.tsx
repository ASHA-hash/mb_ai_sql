    ...
    <div className="section-enter space-y-5">
      ...
      <div className="card p-5" style={{ borderLeft: "4px solid #f59e0b" }}>
        ...
        <div className="space-y-2 text-sm text-slate-600">
          <div className="flex items-start gap-2">
            ...
            <span>Open the Google Sheet → Extensions → ERP Connector → Open panel</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-indigo-500 font-bold">2.</span>
            <span>
              Go to the <strong>Schedule</strong> tab inside the sidebar
            </span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-indigo-500 font-bold">3.</span>
            <span>Choose an interval: Hourly / Every 6 hrs / Every 12 hrs / Daily</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-indigo-500 font-bold">4.</span>
            <span>
              Click <strong>Enable schedule</strong> — a time trigger runs under your Google account
            </span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-indigo-500 font-bold">5.</span>
            <span>Optionally set an alert email or Google Chat webhook</span>
          </div>
        </div>
      </div>
      <div className="card p-5">
        <p className="font-semibold text-slate-700 mb-1.5">
          ...
          <span className="badge bg-amber-100 text-amber-700 ml-2">Coming soon</span>
        </p>
        <p className="text-slate-500 text-sm">
          A future version will support server-side cron jobs so you don&apos;t need Google Sheets open. The API can
          push refreshed data directly to your spreadsheet.
        </p>
